...
```
The rank order divided by n (sample size) will result in the first observation being small (1-1/2)/n but above 0 and the last observation being closer to 1.  These are essentially percentiles if you multiplied them by 100.
